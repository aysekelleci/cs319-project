...
urlpatterns = [
    ...
    path('approve-course/<int:course_id>/<int:student_id>', views.ApproveCoursesView.as_view(), name="approve-courses"),
    path('reject-course/<int:course_id>/<int:student_id>', views.RejectCourseView.as_view(), name="reject-courses"),
 ...
 #   path('create-document/', views.CreateLearningAgreementView.as_view(), name="create-document"),
    ...
    path('compare-documents/<int:student_id>/<int:doc1_id>/<int:doc2_id>', views.CompareDocuments.as_view(),
